...
train_data = utils.shuffle(train_data) # [X,y]
test_data = utils.read_data(test_file) # [X,y]

if train_data[1].ndim > 1:
    print('label must be 1-dim')
    exit(0)
print('read finish')
print('train data size:', train_data[0].shape,'test data size', test_data[0].shape)

train_size = train_data[0].shape[0]
test_size = test_data[0].shape[0]
num_features = len(utils.FIELD_SIZES)
